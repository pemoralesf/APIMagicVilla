    ...
    public class NumeroVillaController : ControllerBase
    {
        ...
        public async Task<ActionResult<APIResponse>> GetNumeroVillas()
        {
            ...
            try
            {
                ...
                IEnumerable<NumeroVilla> numnerovillaList = await _numeroRepo.ObtenerTodos();

                _response.Resultado = _mapper.Map<IEnumerable<NumeroVillaDto>>(numnerovillaList);
        ...
        public async Task<ActionResult<APIResponse>> GetNumeroVilla(int id)
        {
            ...
            try
            {
                if (id == 0)
                {
                    _logger.LogError("Error al traer Numero Villa con Id No. " + id);
